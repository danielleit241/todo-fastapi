...
def test_get_all_users_success_with_response_200(client, authorized_client, email, password):
    """Test retrieving all users via
    API."""
    client, headers = authorized_client(email=email, password=password)
